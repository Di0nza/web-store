...
import {ADMIN_ROUTE, BASKET_ROUTE, LOGIN_ROUTE, SHOP_ROUTE, ORDER_ROUTE} from "../utils/consts";
...
const NavBar = observer(() => {
    ...
    const isAdminLoc = location.pathname === ADMIN_ROUTE
    ...
    return (<Navbar bg="dark" variant="dark">
            <Container>
                ...
                {user.isAuth ? <Nav className="ml-auto">
                    ...
                    <Button variant={"outline-light"} className="m-lg-1"
